...
folder = Path("data/us")
files = [file for file in folder.glob("*.csv")]
print(len(files))
for i in range(len(files)):
    ...
    file_string = str(file).removeprefix("data/" + subfolder + "/").removesuffix("-2024.csv")
    ...
    AEGraph(
        ...
        compheight=1920,
        drop_shadow=True,
        comp_name=file_string + " Adj. X-Lims",
        fps=60,
