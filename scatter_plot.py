"""Generates two somewhat random datasets to demonstrate the scatterplot ability of the API"""
...
scatter_plot_test = (
    AEGraph(width=1280, height=720, compwidth=1920, compheight=1080, drop_shadow=True,comp_name="Scatterplot Test", fps=60)
    .grid()
    .set_xlabel("x")
    .set_ylabel("y")
