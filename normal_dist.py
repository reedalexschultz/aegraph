...
plot = (AEGraph(comp_name="Double Histogram", width=720, height=720, drop_shadow=True, comp_height=1080, comp_width=1080, fps=60)
        .set_title("Histogram")
        .set_xlabel("Value")
...
plot.histogram(
    ...
    .histogram(data, bins=100, color="p_blue", alpha=0.5, label="Normal Distribution (σ = 1)", animate=4.0,bar_anim_times=0.50,density=True,delay=2)
